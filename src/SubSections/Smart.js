  ...
  return (
    <section className="relative bg-white py-16 px-6 md:px-20 font-[Lato]">
      ...
      <div className="mb-10">
        ...
        <h2 className="text-3xl font-bold text-gray-800">Smart Classes</h2>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          <p className="mb-4">
            Smart classes enhance the teaching experience with interactive boards,
            digital content, and engaging multimedia lessons.
          </p>
          <p className="mb-4">
            These technologically enhanced classrooms help students grasp complex
            concepts more effectively and make learning enjoyable.
          </p>
        </div>
      </div>
    </section>
